      ...
      <div className="flex-1 relative bg-black overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center">
          <div className="text-center space-y-4">
            <div className="w-32 h-32 rounded-full bg-gradient-to-br from-teal-500 to-blue-500 mx-auto flex items-center justify-center">
              <Languages className="w-16 h-16" />
            </div>
            <p className="text-gray-400">Camera View (Demo Mode)</p>
          </div>
        </div>
        ...
        {isFrozen && (
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute top-1/3 left-1/4 w-1/2">
            ...
            <div className="absolute top-1/2 left-1/3 w-1/3">
              <div className="border-2 border-teal-500 rounded p-2 bg-black/50 backdrop-blur-sm">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-4 py-2 rounded-full bg-black/50 backdrop-blur-sm hover:bg-black/70 transition-colors"
              >
                <span className="text-sm">{sourceLanguage} → {targetLanguage}</span>
              </button>
            </div>
            ...
            <Button
              ...
              className="rounded-full bg-black/50 backdrop-blur-sm hover:bg-black/70"
            >
              {isFlashOn ? <Zap className="w-5 h-5 text-yellow-400" /> : <ZapOff className="w-5 h-5" />}
            </Button>
          </div>
        </div>
        ...
        {showLanguageSelector && (
          <div className="absolute top-20 left-1/2 -translate-x-1/2 bg-[#1a1a1a] border border-white/10 rounded-2xl p-4 backdrop-blur-xl w-80">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent">
          <div className="flex items-center justify-center gap-8">
            ...
            <Button
              ...
              className="w-16 h-16 rounded-full bg-gradient-to-r from-teal-500 to-blue-500 hover:from-teal-600 hover:to-blue-600 text-white border-4 border-white/30"
            >
          ...
          <div className="text-center mt-4">
            ...
            {isFrozen && (
              <Button
                onClick={toggleFreeze}
                className="mt-2 bg-white/10 hover:bg-white/20 text-white border-0 rounded-full backdrop-blur-sm"
              >
                Unfreeze Frame
              </Button>
            )}
